...
export const Projects: IProject[] = [
    ...
    {
        title: "US Institutional Website | 2023",
        description: "Front-end development of the US institutional website for IGC Partners.",
        url: "https://igcp.com",
    ...
    {
        title: "TCC (Sustainable Analysis of the Paper and Pulp Sector in Brazil) | 2022 and 2023",
        description:
            "Graduation project related to the quantitative and qualitative sustainable analysis of paper and pulp sector in Brazil, together with 2 teamworkers. Worked on analyzing a large dataset (more than 170 indicators for 50 different regions and various sectors) using Python and the Pandas library.",
        url: "https://github.com/willersantos-work/TCC-Analysis",
        technologies: ["Python", "Pandas", "Data analysis"]
    },
    {
        title: "Precatórios Brasil | 2021 and 2022",
        description:
            "Fullstack development for a CRM of precatórios (a type of debt owed by the government to a person, which a bank can purchase from the person).",
        technologies: [".Net Core", "React", "CI/CD", "Jenkins", "Kubernetes", "RabbitMQ", "PostgreSQL", "Web"]
    },
    {
        title: "RAS (Risk Analysis System) | 2021",
        description: "Fullstack development for a trades CRM.",
    ...
    {
        title: "Carry | 2020",
        description: "Design conception for a website and app CRM for ambulances.",
        technologies: ["Figma", "Design Thinking", "Web", "App"]
    },
    {
        title: "CheckPrice | 2020",
        description: "Design conception for an online dispatcher website.",
