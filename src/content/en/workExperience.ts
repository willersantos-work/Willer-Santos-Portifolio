...
export const WorkExperience: IWorkExperience[] = [
    ...
    },
    {
        ...
        description: [
            "Developed tasks from development environment to production environment following Scrum with a range of tools such as (I) Postman; (II) AWS Lambda and CloudWatch; (III) Azure pipelines (Build and Release); and (IV) Git."
        ],
    ...
    },
    {
        ...
        description: [
            "Worked on the organization of visitor’s data analysis by structuring data collecting strategies with the goal of getting visitor’s data efficiently",
            "Took part in a channel with medium and large-sized companies with the purpose of monitoring and leading sales to these potential event sponsors. Also managed company’s participation in the event."
        ],
    ...
    },
    {
        ...
        description: [
            "Build projects up with different Frameworks, such as React, React Native and NodeJS (Express) with Tribe structure.",
            "Worked in web and app design system projects by using Figma and FigmaJam under the Design Thinking Methodology.",
            "Planned projects, such as (I) database modeling, (II) project documentation and (III) structure task backlog."
        ],
